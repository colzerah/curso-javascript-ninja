...
name = ["DY", "E", "GO"];
console.log(name.reduce(function(acumulado, item){
...
*/
console.log( '\nInversed Name:' );
inversedName = name.reduceRight(function(acumulado, item){
...
console.log("Sim existe mais na hora de validar o { number: 2 }, sempre vai da -1 porque um objeto não é igual a outro na memoria."); 
