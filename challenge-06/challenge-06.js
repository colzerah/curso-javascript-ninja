...
desafio.
*/
var teams = ["Flamengo", "São Paulo", "Corintias", "Palmeiras", "Vasco"];
...
showTeamPosition(1); // "O time que está em 2º lugar é o São Paulo."
showTeamPosition(2); // "O time que está em 3º lugar é o Corintias."
showTeamPosition(4); // "O time que está em 5º lugar é o Vasco."
...
function convertToHex(cor){
    switch(cor){
        case "Vermelho": console.log("O hexadecimal para a cor " + cor + " é #FF0000.");
        break;
        case "Verde": console.log("O hexadecimal para a cor " + cor + " é #008000.");
        break;
        case "Azul": console.log("O hexadecimal para a cor " + cor + " é #0000FF.");
        break;
        case "Rosa": console.log("O hexadecimal para a cor " + cor + " é #FFC0CB.");
        break;
        case "Amarelo": console.log("O hexadecimal para a cor " + cor + " é #FFFF00.");
        break;
