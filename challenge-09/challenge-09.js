...
*/
function calculator(num, numDois){
    return function (callback){
        return callback(num, numDois);
    };
}
...
*/
var subtraction = calculator(30, 20);
var multiplication = calculator(2, 15);
var division = calculator(60, 3);
