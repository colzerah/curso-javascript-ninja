(function () {
    ...
    */
    function showOperationMessage(op, numero1, numero2){
        return "A operação " + numero1 + " " + op + " " + numero2 + " =";
    }
   ...
   */
    ...
    */
   operationSignal = 10;
   var msngErro = calculator(operationSignal);
   if(msngErro !== false){
       number1 = 10;
       number2 = 20;
       console.log(showOperationMessage(operationSignal, number1, number2), msngErro(number1, number2));
   }else{
       console.log(showErrorMessage(operationSignal));
   }
